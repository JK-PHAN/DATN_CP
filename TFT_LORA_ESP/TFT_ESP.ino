...
String processData(String data) {
  ...
  if (data.startsWith("ID1")) {
    ...
    int pm1 = data.substring(data.indexOf("PM1:") + 4, data.indexOf(",PM2.5:")).toInt();
    ...
    tft.println("PM1: " + String(pm1) + " ug/m3");
    tft.println("PM2.5: " + String(pm25) + " ug/m3");
    tft.println("PM10: " + String(pm10) + " ug/m3");
